...
export default function ResetAdminPasswordPage() {
  ...
  const onSubmit = async (data: ResetPasswordForm) => {
    ...
    try {
      await adminAPI.resetAdminPassword(adminId, data);
      router.push('/admin/administrators?success=Password reset successfully');
    } catch (err: any) {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white shadow sm:rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <h1 className="text-2xl font-bold text-gray-900 mb-6">Reset Administrator Password</h1>
